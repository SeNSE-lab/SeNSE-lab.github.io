...
function up()
{
    ...
    listdir($filefolder);
    echo $content . "</select><br><br>" . "<input type=\"submit\" value=\"Upload\" class=\"button\">\n" . "</form>\n";
    mainbottom();
}
...
function cr()
{
    ...
    maintop("Create");
    if(!$content=="") {
        echo "<br><br>Please enter a filename.\n";
    }
...
function logout()
{
    ...
    echo "Your are now logged out." . "<br><br>" . "<a href=" . $adminfile . "?op=home>Click here to Log in again</a>";
    mainbottom();
}
function mainbottom()
{
